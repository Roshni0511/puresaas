...
import RealCRM from '../src/data/RealCRM.json'
...
export default function RealEstateAgentCRMs() {
  ...
  // const plans = [
  //   { id: 1, name: "Individual", monthly: 2999, yearly: 29999 },
  //   { id: 2, name: "Enterprise ", monthly: 3999, yearly: 39999 },
  //   { id: 3, name: " Business", monthly: 4999, yearly: 49999 }
  // ];
  ...
  const handleSubmit = async (event) => {
    ...
    const apiUrl =
      "https://shubhamsingh.in/Application_Tracking_System/booking_demo";
    try {
...
{selectedPlan && (
        ...
        />
                ...
                <div className="container" >
                  <div className="sec-head mb-50">
                    <h6 style={{ color: '#8c8c8c', marginBottom: '10px', justifyContent: 'center', display: 'flex', }}>Real Estate Agent CRM</h6>
                    <h6 className="sub-title mb-25 fontmanage"
                      style={{ justifyContent: 'center', display: 'flex', fontSize: "35px" }}>
                      WHY Real Estate Agent CRM
                    </h6>
