...
import data from '../src/data/portfolios/Broadcasting.json'
            ...
            <main className="main-bg">
                ...
                <div className="container">
                  <div style={{ paddingTop: '80px' }}>
                    <div className="d-flex flex-column align-items-center text-center w-100">
                      <h3 className="d-flex justify-content-center text-center " style={{ marginBottom: '30px' }} >
                        Broadcast better with the <br /> world's favorite CRM
                      </h3>
                    </div>
                    <div>
                      <p className='text-center' style={{ fontSize: '20px', textAlign: 'justify' }}>
                        Customer relationship management (CRM) tools have revolutionized the way businesses connect with their audiences, making communication more effective and personalized. With the world's favorite CRM, you can streamline your messaging, target the right customers, and build stronger relationships—all from a single platform.
                      </p>
                    </div>
              ...
              <div className='container'>
                ...
                <div style={{ marginTop: '30px' }}>
                  <img src='/dark/assets/imgs/background/Broadcast.png' />
                </div>
              </div>
                ...
                <div className="container">
                  <div className="sec-head mb-50 d-flex flex-column align-items-center text-center w-100">
                    <h6 className="sub-title main-color mb-3 d-flex justify-content-center text-center fs-3">
                      Why choose Puresaas CRM for <br /> satellite broadcasting?
                    </h6>
