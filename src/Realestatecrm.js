...
// import RealCRM from '../../../data/portfolios/Realestatecrm.json'
import RealCRM from '../src/data/portfolios/Realestatecrm.json';
...
import offeres from '../src/data/Features.json'
...
export default function Realestatecrms() {
  ...
  const handleSubmit = async (event) => {
    ...
    const apiUrl =
      "https://shubhamsingh.in/Application_Tracking_System/real_estate_demo";
          ...
          <div id="smooth-content"                    >
            <main className="main-bg">
              ...
              <section className="services " style={{ paddingBottom: '100px' }}>
                ...
                <div className="container">
                  <div className="sec-head mb-50">
                    <h6 style={{ color: '#8c8c8c', marginBottom: '10px', justifyContent: 'center', display: 'flex', }}>Builder/Broker CRM</h6>
                    <h6 className="sub-title mb-25 fontmanage" style={{ justifyContent: 'center', display: 'flex', fontSize: "35px" }} >WHY Builder/Broker CRM</h6>
              ...
              <section className="services section-padding pb-0">
                <div className="container">
                  ...
                  <div style={{ paddingTop: '60px' }}>
                    <div>
                      <h4 style={{ justifyContent: 'center', display: 'flex', marginBottom: '20px' }}>Benefits of a Realestate CRM software</h4>
                    </div>
                    <div>
                      ...
                      >
                        ...
                        >
                          ...
                          <span style={{ fontSize: '20px' }}>Improved Client
                            Relationships</span>
                        </div>
                        ...
                        >
                          ...
                          <span style={{ fontSize: '20px' }}>Efficient Lead
                            Management</span>
                        </div>
                        ...
                        >
                          ...
                          <span style={{ fontSize: '20px' }}>Streamlined Property
                            Management</span>
                        </div>
                        ...
                        >
                          ...
                          <span style={{ fontSize: '20px' }}>Advanced Reporting
                            and Analytics</span>
                        </div>
                      </div>
