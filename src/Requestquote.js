...
export default function Requestquotes() {
    ...
    try {
      const response = await fetch(apiUrl, {
        ...
        body: JSON.stringify({
          ...
          product_name: productname,  // Ensure this is defined
        }),        
      });
  ...
  return (
    <>
      ...
      <body>
        ...
        name="productname"
        readOnly
        style={{ display: "block", textAlign: "center", marginBottom: "10px" }} // Read-only field
      /> */}
                        <div className="controls row">
                          <div className="col-lg-12">
                            <div className="form-group mb-30" style={{ position: "relative" }}>
                              ...
                              >
                                <MdPeopleOutline  size={20} color="#555" />
                              </div>
                          ...
                          {/* <div className="col-lg-12" style={{ position: "relative" }}>
                            <div className="form-group mb-30">
                              ...
                              <PhoneInput
                                country={"in"} 
                                value={formData.contact_number} // Keeping the original value
                                ...
                                enableSearch={true} // Enables search box in dropdown
                                inputProps={{
                                  id: "number",
                                  name: "number",
                                  required: true,
                                ...
                                containerStyle={{ width: "100%", marginBottom: "16px" }} // Full width + margin-bottom
                                inputStyle={{
                                  // width: "100%",
                                ...
                                dropdownStyle={{
                                  ...
                                  color: "#000", // Black text for countries
                                  width: "250px", // Proper dropdown width
                                }}
                                searchStyle={{
                                  backgroundColor: "#fff", // White search box
                                  color: "#000", // Black search text
                                  border: "1px solid #ccc", // Light border
                                  padding: "5px",
                                }}
                                onFocus={(e) => {
                                  e.target.style.border = "1px solid #fff"; // White border on focus
                                  e.target.style.boxShadow = "none"; // White border on focus
                                }}
                                onBlur={(e) => {
                                  e.target.style.border =
                                    "1px solid rgba(255, 255, 255, 0.2)"; // Reset border on blur
                                }}
                              />
                            </div>
  ...
  <div className="form-group mb-30" style={{ position: "relative" }}>
    ...
    <div
      ...
      onClick={() => document.getElementById("form_phone").focus()}
    >
      <MdPhone size={20} color="#555" />
    </div>
  </div>
