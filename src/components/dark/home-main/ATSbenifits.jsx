...
import offer from '../../../data/portfolios/ATSBenifit.json'
export default function ATSbenifits() {
    return (
        <section className="services pb-20" style={{paddingTop:'80px'}}>
          <div className="container">
            <div className="sec-head mb-80">
              {/* <h6 className="sub-title main-color mb-25">Our Specialize</h6> */}
              {/* <div className="bord pt-25 bord-thin-top d-flex align-items-center"> */}
                <h2 className="fw-600 text-u ls1 fontmanage" style={{display:'flex',justifyContent:'center'}}>
                Your Benefit 
                </h2>
