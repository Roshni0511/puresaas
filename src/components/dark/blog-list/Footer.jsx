              ...
              <div className="call-action">
                <h2 className="d-slideup wow fz-60 fw-600">
                  <span className="sideup-text">
                    <span className="up-text">Havejghujhjihjk a project in mind?</span>
                  </span>
                  <span className="sideup-text">
                    <span className="up-text underline">
                      <a href="/dark/contactus" className="main-color">
                        Let’s get to work.
                      </a>
                    </span>
                  </span>
                ...
                <div className="row">
                  <div className="col-6">
                    <ul className="rest fz-14">
                      <li className="mb-15">
                        <a href="/dark/Enterprise">About</a>
                      </li>
                      <li className="mb-15">
                      ...
                      <li>
                        <a href="/dark/contactus">Contact</a>
                      </li>
                    </ul>
                  </div>
                  <div className="col-6">
