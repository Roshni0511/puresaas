...
import offeres from '../src/data/portfolios/Servicecrm1.json'
...
import RealCRM from '../src/data/portfolios/Servicecrm.json'
...
export default function Servicecrmpages() {
  ...
  const handleSubmit = async (event) => {
    ...
    const apiUrl =
      "https://shubhamsingh.in/Application_Tracking_System/service_demo";
  ...
  {selectedPlan && (
                ...
                <div className="container">
                  <div className="sec-head mb-50">
                    <h6 style={{ color: '#8c8c8c', marginBottom: '10px', justifyContent: 'center', display: 'flex', }}>Service CRM</h6>
                    <h6 className="sub-title mb-25 fontmanage" style={{ justifyContent: 'center', display: 'flex', fontSize: "35px" }}>           WHY Service CRM</h6>
