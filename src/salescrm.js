...
import offeres from '../src/data/salespage.json'
import RealCRM from '../src/data/Realsales12.json'
...
export default function Salescrms() {
  ...
  useEffect(() => {
   ...
   const [showPassword, setShowPassword] = useState(false);
          ...
          const handleSubmit = async (event) => {
            ...
            const apiUrl =
              "https://shubhamsingh.in/Application_Tracking_System/sales_crm_demo";
          ...
          <div id="smooth-content" >
            ...
            <input   type="text"   value={pageTitle}      style={{ textAlign: "center", marginBottom: "10px", display: "none", }} />
             ...
             {selectedPlan && (
                ...
                <div className="container">
                  <div className="sec-head mb-50">
                    <h6 style={{ color: '#8c8c8c', marginBottom: '10px', justifyContent: 'center', display: 'flex', }}>Sales CRM</h6>
                    <h6 className="sub-title mb-25 fontmanage" style={{ justifyContent: 'center', display: 'flex', fontSize: "35px" }}>WHY Sales CRM</h6>
              ...
              <section className="services section-padding pb-0">
                <div className="container">
                  ...
                  <div style={{ paddingTop: '60px' }}>
                    <div>
                      <h4 className='fontmanage' style={{ justifyContent: 'center', display: 'flex', marginBottom: '20px' }}>Benefits of a Sales CRM software</h4>
                    </div>
                    <div>
